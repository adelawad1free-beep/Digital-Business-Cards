...
export const TRANSLATIONS: TranslationStrings = {
  ...
  login: { en: 'Login', ar: 'دخول', es: 'Iniciar sesión', fr: 'Connexion', de: 'Anmelden', zh: '登录', ja: 'ログイン', pt: 'Entrar', ru: 'Вход', hi: 'لॉगिन' },
  logout: { en: 'Logout', ar: 'خروج', es: 'Cerrار sesión', fr: 'Déconnexion', de: 'Abmelden', zh: '退出', ja: 'ログアウト', pt: 'Sair', ru: 'Выход', hi: 'لॉगआउट' },
  ...
  gradient: { en: 'Gradient', ar: 'تدرج', es: 'Degradado', fr: 'Dégradé', de: 'Verlauf', zh: '渐变', ja: 'グラデーション', pt: 'Gradiente', ru: 'Градиент', hi: 'ढال' },
  ...
  buttons: { en: 'Buttons', ar: 'الأزرار', es: 'Botones', fr: 'Boutons', de: 'Buttons', zh: '按钮', ja: 'ボタン', pt: 'Botões', ru: 'Кнопки', hi: 'بटन' },
  socialLinks: { en: 'Socials', ar: 'التواصل', es: 'Social', fr: 'Social', de: 'Soziales', zh: '社交', ja: 'ソーシャル', pt: 'Social', ru: 'Соцсети', hi: 'सोशल' },
  classic: { en: 'Classic', ar: 'كلاسيك', es: 'Clásico', fr: 'Classique', de: 'Klassisch', zh: '经典', ja: 'クラシック', pt: 'Clássico', ru: 'Классика', hi: 'क्لاсик' },
  split: { en: 'Split', ar: 'منقسم', es: 'Dividido', fr: 'Divisé', de: 'Geteilt', zh: '分屏', ja: 'スプリット', pt: 'Dividido', ru: 'Разделение', hi: 'विभाजित' },
  overlay: { en: 'Overlay', ar: 'متداخل', es: 'Superpuesto', fr: 'Superposé', de: 'Overlay', zh: '叠加', ja: 'オーバーレイ', pt: 'Sobreposto', ru: 'Наложение', hi: 'オーバーले' },
  ...
  squircle: { en: 'Squircle', ar: 'منحنٍ', es: 'Squircle', fr: 'Squircle', de: 'Squircle', zh: '圆角', ja: 'スクワークル', pt: 'Squircle', ru: 'Сквиركل', hi: 'स्क्विर्कल' },
