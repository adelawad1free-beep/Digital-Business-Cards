...
export const TRANSLATIONS: TranslationStrings = {
  ...
  account: { en: 'Account', ar: 'الحساب', es: 'Cuenta', fr: 'Compte', de: 'Konto', zh: '账户', ja: 'アカウント', pt: 'Conta', ru: 'Аккаунт', hi: 'खाتا' },
  ...
  placeholderName: { en: 'Enter your name', ar: 'أدخل اسمك الكامل', es: 'Ingresa tu nombre', fr: 'Entrez votre nom', de: 'Name eingeben', zh: '输入姓名', ja: '名前を入力', pt: 'Digite seu nome', ru: 'Введите имя', hi: 'अपना نام दर्ज करें' },
  theme: { en: 'Theme', ar: 'السمة', es: 'Tema', fr: 'Thème', de: 'Theما', zh: '主题', ja: 'テーマ', pt: 'Tema', ru: 'Тема', hi: 'थीم' },
  saveContact: { en: 'Save Contact', ar: 'حفظ جهة الاتصال', es: 'Guardar contacto', fr: 'Enregistrer le contact', de: 'Kontakt speichern', zh: '保存联系人', ja: '連絡先を保存', pt: 'Salvar contato', ru: 'Сохранить контакт', hi: 'संपرك سहेजें' },
  call: { en: 'Call', ar: 'اتصال', es: 'Llamار', fr: 'Appeler', de: 'Anrufen', zh: '呼叫', ja: '電話', pt: 'Ligar', ru: 'Позвонить', hi: 'كॉल करें' },
  ...
  heroTitle: { en: 'Professional Digital Business Cards', ar: 'بطاقات أعمال رقمية احترافية', es: 'Tarjetas de visita digitales', fr: 'Cartes de visite numériques', de: 'Digitale Visitenkarten', zh: '专业数字名片', ja: 'プロフェッショナルな名片', pt: 'Cartões de Visita Digitais', ru: 'Цифровые визитки', hi: 'पेशेور 디지털 ビジネス カード' },
  ...
  createBtn: { en: 'Create Now', ar: 'ابدأ الآن', es: 'Creار ahora', fr: 'Créer maintenant', de: 'Jetzt erstellen', zh: '立即创建', ja: '今すぐ创建', pt: 'Criar agora', ru: 'Создать сейчас', hi: 'अभी बनाएं' },
  ...
  locationUrl: { en: 'Google Maps Link', ar: 'رابط خريطة قوقل', es: 'Enlace Google Maps', fr: 'Lien Google Maps', de: 'Google Maps Link', zh: 'Google Maps 链接', ja: 'Google Maps リンク', pt: 'Link Google Maps', ru: 'Ссылка Google Maps', hi: 'गूगल मैप्स लिंक' },
  ...
  visitUs: { en: 'Visit Us', ar: 'تفضل بزيارتنا', es: 'Visítanos', fr: 'Visitez-nous', de: 'Besuchen Sie uns', zh: '访问我们', ja: 'お問い合わせ', pt: 'Visite-nos', ru: 'Посетите нас', hi: 'हमसे मिलें' },
  ...
  jobTitle: { en: 'Job Title', ar: 'المسمى الوظيفي', es: 'Cargo', fr: 'Postه', de: 'Berufsbezeichnung', zh: '职位', ja: '役職', pt: 'Cargo', ru: 'Доلжность', hi: 'पद' },
  ...
  templatesDesc: { en: 'Choose the perfect design that reflects your professional identity.', ar: 'اختر التصميم المثالي الذي يعكس هويتك المهنية الراقية.', es: 'Elige el diseño perfecto.', fr: 'Choisissez le design parfait.', de: 'Wählen Sie das perfekte Design.', zh: '选择反映您身份的完美設計。', ja: 'あなたのアイデンティティを反映するデザインを選択してください。', pt: 'Escolha o design perfecto.', ru: 'Выберите идеальный تصميم.', hi: 'अपनी पहचान को दर्शाने वाला डिज़ाइन चुनें।' },
  ...
  noCardsYet: { en: 'No cards yet', ar: 'لا توجد بطاقات حتى الآن', es: 'Sin tarjetas aún', fr: 'Pas encore de كارتس', de: 'Noch keine Karten', zh: '暂无名片', ja: 'まだカードはありません', pt: 'Nenhum cartão ainda', ru: 'Нет карточек', hi: 'अभी तक कोई कार्ड नहीं' },
  ...
  invitationWelcome: { en: 'Welcomes you to', ar: 'بدعوتكم لحضور', es: 'Te invita a', fr: 'Vous invite à', de: 'Lädt Sie ein zu', zh: '欢迎您参加', ja: 'あなたを歓迎します', pt: 'Convida você para', ru: 'Приглашает вас на', hi: 'आपका स्वागत کرتا है' },

  editTemplate: { en: 'Edit Template', ar: 'تعديل القالب', es: 'Editar plantilla', fr: 'Modifier le modèle', de: 'Vorlage bearbeiten', zh: '编辑模板', ja: 'テンプレートを編集', pt: 'Editar Modelo', ru: 'Изменить шаблон', hi: '테म्प렛 संपादित करें' },
  saveTemplate: { en: 'Save Template', ar: 'حفظ القالب', es: 'Guardار plantilla', fr: 'Enregistrer le modèle', de: 'Vorlage speichern', zh: '保存模板', ja: 'テンプレートを保存', pt: 'Salvar Modelo', ru: 'Сохранить шаблон', hi: '테म्प렛 سहेजें' },
  ...
  header: { en: 'Header', ar: 'الترويسة', es: 'Encabezado', fr: 'En-tête', de: 'Header', zh: '页眉', ja: 'ヘッダー', pt: 'Cabeçalho', ru: 'Шапка', hi: 'ヘッدر' },
  ...
  size: { en: 'Size', ar: 'الحجم', es: 'Tamaño', fr: 'Taille', de: 'Größe', zh: '尺寸', ja: 'サイズ', pt: 'Tamanho', ru: 'Разمر', hi: 'آكار' },
  ...
  minimal: { en: 'Minimal', ar: 'بسيط', es: 'Mínimo', fr: 'Minimal', de: 'Minimal', zh: '极简', ja: 'ミニمال', pt: 'Mínimo', ru: 'Минимализм', hi: 'نظام' },
  circle: { en: 'Circle', ar: 'دائري', es: 'Círculo', fr: 'Cercle', de: 'Kreis', zh: '圆形', ja: 'サークル', pt: 'Círculo', ru: 'Кروг', hi: 'वृत्त' },
  squircle: { en: 'Squircle', ar: 'منحنٍ', es: 'Squircle', fr: 'Squircle', de: 'Squircle', zh: '圆角', ja: 'スクワークل', pt: 'Círculo', ru: 'سكويركل', hi: 'स्कुइركل' },
  ...
  specialLinks: { ar: 'روابط خاصة (صور)', en: 'Special Links (Images)' },
  addSpecialLink: { ar: 'إضافة رابط صورة جديد', en: 'Add New Image Link' },
  specialLinkUrl: { ar: 'رابط الوجهة', en: 'Destination URL' },
