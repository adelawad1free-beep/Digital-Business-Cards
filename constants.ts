...
export const TRANSLATIONS: TranslationStrings = {
  ...
  selectTemplate: { en: 'Select Style', ar: 'اختر النمط الهيكلي', es: 'Seleccionar estilo', fr: 'Choisir le style', de: 'Stيل wählen', zh: '选择样式', ja: 'スタイルを選択', pt: 'Selecionar Estilo', ru: 'Выбрать стиль', hi: 'शैली चुनें' },
  ...
  classic: { en: 'Classic', ar: 'كلاسيك', es: 'Clásico', fr: 'Classique', de: 'Klassisch', zh: '经典', ja: 'クラシック', pt: 'Clássico', ru: 'Классика', hi: 'क्لاسيك' },
